...
CREATE TABLE `sms_home_subject`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '首页专题表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_sku_ladder`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '商品阶梯价格' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sms_sku_ladder
-- ----------------------------
INSERT INTO `sms_sku_ladder` VALUES (1, 14, 0, 0.00, NULL, 0);
...
CREATE TABLE `sms_spu_bounds`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '商品spu积分设置' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sms_spu_bounds
-- ----------------------------
INSERT INTO `sms_spu_bounds` VALUES (1, 4, 10.0000, 10.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (2, 5, 10.0000, 10.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (3, 6, 10.0000, 10.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (4, 7, 10.0000, 10.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (5, 8, 10.0000, 10.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (6, 9, 10.0000, 10.0000, NULL);
