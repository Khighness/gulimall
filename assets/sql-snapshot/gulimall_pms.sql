...
CREATE TABLE `pms_attr`  (
  ...
  `value_type` tinyint(1) NULL DEFAULT NULL COMMENT '值类型[0-单选，1-多选]',
...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '属性分组' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '品牌' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of pms_brand
-- ----------------------------
INSERT INTO `pms_brand` VALUES (1, '荣耀', 'https://khighness-gulimall.oss-cn-shanghai.aliyuncs.com/2021-10-12/958968b2-120c-40b0-8364-ea703f75aa92_honor.jpg', '荣耀', 1, 'r', 1);
INSERT INTO `pms_brand` VALUES (2, '华为', 'https://khighness-gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-17/8dc8ed37-f75e-4890-8a54-8a8d57bdb855_huawei.png', '华为', 1, 'h', 0);
INSERT INTO `pms_brand` VALUES (3, '小米', 'https://khighness-gulimall.oss-cn-shanghai.aliyuncs.com/2021-10-12/e39149d9-b13e-4cfc-8e6d-c58384969c0a_mi.jpg', '小米', 0, 'm', 0);
INSERT INTO `pms_brand` VALUES (4, 'oppo', 'https://khighness-gulimall.oss-cn-shanghai.aliyuncs.com/2021-10-12/47b4651a-d99b-4044-8e99-87a24a87e337_oppo.jpg', 'oppo', 1, 'o', 0);
INSERT INTO `pms_brand` VALUES (5, 'vivo', 'https://khighness-gulimall.oss-cn-shanghai.aliyuncs.com/2021-10-12/299939ad-f636-40f2-841c-2aa517be3b8f_vivo.jpg', 'vivo', 0, 'v', 0);
INSERT INTO `pms_brand` VALUES (6, 'K', 'https://khighness-gulimall.oss-cn-shanghai.aliyuncs.com/2021-10-12/e481bea6-7167-4a14-85a7-3baf91ea5695_K.jpg', 'parak', 2, 'K', 0);
INSERT INTO `pms_brand` VALUES (7, 'Y', 'https://khighness-gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-31/9152704c-7bf9-4981-8659-b1783e777e87_嘤嘤嘤.jpg', '嘤嘤嘤', 1, 'y', 6);
...
INSERT INTO `pms_category` VALUES (2, '手机', 0, 1, 1, 0, 'Kphone', '部', 0);
...
CREATE TABLE `pms_category_brand_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '品牌分类关联' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `pms_product_attr_value`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 61 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'spu属性值' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 24 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'sku信息' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `pms_sku_sale_attr_value`  (
  ...
  `attr_sort` int NULL DEFAULT NULL COMMENT '顺序',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 47 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'sku销售属性&值' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `pms_spu_images`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 24 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'spu图片' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `pms_spu_info`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'spu信息' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of pms_spu_info
-- ----------------------------
INSERT INTO `pms_spu_info` VALUES (3, '华为 HUAWEI P40 Pro+ 麒麟990 5G ', '华为 HUAWEI P40 Pro+ 麒麟990 5G ', 225, 2, 0.5700, 1, '2020-06-06 10:40:25', '2021-12-20 14:41:24');
